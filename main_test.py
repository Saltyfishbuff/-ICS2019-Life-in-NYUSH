...
class MyWindow(QMainWindow, Ui_MainWindow):
        ...
        if building is not None:
            ...
            # if building.objectName() not in ["bursar", "CDC", "student_life"]:
                ...
                if building.owner is None:
                    ...
                    self.yes.clicked.connect(lambda: self.buy(player, building)) #to allow the function holding the parameters
                ...
                # passing my building: upgrade
                    ...
                    self.buy_info.setText("Do you want to upgrade this building?")
                    self.buy_info.show()
                    self.info.show()
            ...
            mysend(self.s, json.dumps(d))
            self.info.setText("Time to have a rest!")
            self.info.show()
            self.yes.show()
            self.yes.clicked.connect(self.confirm)
    ...
    def pass_building_update(self, player, x, y, msg):
        ...
        if building is not None:
            ...
            self.info.setText("Others is having a rest!")
            self.info.show()
    ...
    def destiny(self, player):
        ...
        list_destiny = [['Your stuff in 314 has been removed \nand lost, you lost $2000.', 2000],
                        ...
                        ['You bought Mate Tea for $1000 during \nGPS to get rid of sleepiness.', 1000],
                        ['You missed shuttle and get a \ntaxi back to the dorm for $1000.', 1000],
                        ['You bought bubble tea for $1000.', 1000],
                        ['You purchased textbook for $5000.', 5000],
                        ['You lost your campus card,  \nyou have to go to Public Safety \nto replace it for $3000.', 3000],
                        ['You bought tickets and clothes \nfor Spring Formal for $2000.', 2000],
                        ['Arc told you to rewrite your essay,\nyou spent 2000 on stress eating.', 2000],
                        ['You find hair in your meal\nand ordered another food on elema.', 1000],
                        ['Pay for military training.', 2000],
                        ['You were collapsed by\nthe smell of the moor besom\nin front of AB.', 1000]]
    ...
    def chance(self, player):
        assert isinstance(player, Player)
        list_chance = [
            ['You have been offered for the position of RA\nand get payment for $5000!',5000],
            ['You have been recommended an internship by \nprofessor and get payment for $2000!', 2000],
            ['You get the tuition-fee refund for $3000!', 3000],
            ['You have been offered for the position of OA\nand get payment for $1500!', 1500],
            ['You have been offered for the position of \nresearch assistant and get payment for $2000!', 2000],
            ['You have been offered a on-campus job\nand get payment for $3000!', 3000],
            ['You win the prize of $1000 by taking a survey!', 1000],
            ['You participate in an event and\nget free lunch of $1000 in return!', 1000],
            ['You get additional $5000 voucher from Starbucks!', 5000],
            ['You helped with commencement and got $2000', 2000]]               
